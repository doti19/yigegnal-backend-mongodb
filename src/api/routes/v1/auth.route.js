...
router.route('/register')
  .post(validator.body(register ), controller.register);
 ...
 */
router.route('/login')
  .post(validator.body(login.body), controller.login);
...
router.route('/refresh-token')
  .post(validator.query(refresh.body), controller.refresh);

router.route('/send-password-reset')
  .post(validator.query(sendPasswordReset.body), controller.sendPasswordReset);

router.route('/reset-password')
  .post(validator.query(passwordReset.body), controller.resetPassword);
